...
const chat_names = ["Darshana", "Chandana", "Arun", "Havirbhavi", "Darshu", "Kammoo", "Havi"];
...
class ChatHandler{
    ...
    createNode(id){
        ...
        console.log("1.jpeg" + eval(1+(id%chat_img_length)) + ".jpeg");
        chat_item.querySelector('#Image').src = "2.jpeg" + eval(1+(id%chat_img_length)) + ".jpeg";
